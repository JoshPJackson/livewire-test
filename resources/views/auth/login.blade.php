...
<div class="bg-purple flex w-100 h-full items-center justify-center">
    <div class="bg-white rounded-xl shadow h-fit p-10">
        ...
        <form class="grid grid-rows-2 grid-cols-min-auto-1 gap-x-2" id="login">
            <label for="email" class="mb-2 text-lg text-sans w-min mt-2">Email</label>
            ...
            <label for="password" class="mb-2 text-lg text-sans w-min mt-2">Password</label>
        ...
        <div class="flex justify-between">
            <a href="#" class="border-blue-200 border-2 text-blue-200 px-4 py-2 rounded-full">Create Account</a>
