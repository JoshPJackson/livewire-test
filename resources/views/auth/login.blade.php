...
<div class="bg-purple flex w-100 h-full items-center justify-center">
    <div class="bg-white rounded-xl shadow h-fit p-10">
        ...
        <form class="grid grid-rows-2 grid-cols-min-auto-1 gap-x-2" id="login" action="/login" method="post">
            ...
            <input type="email" class="mb-4 py-2 px-5 d-block w-full rounded-full border-2 focus:outline-none focus:border-purple hover:border-purple text-gray-400" name="email" id="email" placeholder="me@example.com">
            <label for="password" class="mb-2 text-lg text-sans w-min mt-2 font-thin">Password</label>
            <input type="password" class="mb-4 py-2 px-5 d-block w-full rounded-full border-2 focus:outline-none focus:border-purple hover:border-purple text-gray-400" name="password" id="password">
        </form>
